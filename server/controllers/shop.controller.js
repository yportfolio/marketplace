 ...
 * and we will read it using the fs module to retrieve the filetype
 * and data to store it in the image field in the shop document.”
 */
 ...
 * @param {*} req
 * @param {*} res
 *up date  all shops fields, update the updated date by hands
 */
